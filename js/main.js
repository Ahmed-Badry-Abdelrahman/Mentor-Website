...
let cards = document.querySelectorAll('.card-sec6');
if (window.location.href.includes('index.html') || window.location.href.includes('courses.html')) {
    cards.forEach((card) => {
        card.onclick = () => {
            location.href = '../html/courses_details.html'
        }
    })
}